...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-14T08:41:47Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 19.2%(악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.6배(악재)·KOSPI 12M Fwd PER 4.6배(강한 호재)·주식위험프리미엄(ERP) 0.53%p(중립)·미국 10Y 금리 4.61%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.58%p(호재)·USD/KRW 1494.0원(호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 105.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -13.0조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 17.3(중립)·S&P500 12M 모멘텀 18.5%(강한 호재)·CNN 공포·탐욕 지수 44(중립)·AAII 불-베어 스프레드 -0.9%p(중립)·CBOE 풋/콜 비율(총) 0.96(중립)",
