...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "0.86 → 0.86 (2026-08-08 발표)",
      "as_of": "2026-08-08"
    }
  ],
  "updates_today": [
  ...
  "generated": "2026-08-08T00:05:16Z",
  "regime": {
    "score": 17,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "signals": [
      {
        ...
        "status_ko": "주의",
        "threshold": "30% 이상 경고",
        "desc": "10Y-3M 스프레드 +0.78%p 기반 12개월 내 침체확률(Estrella-Mishkin probit). 역사상 30% 돌파 시 대부분 침체 선행.",
        "source": {
          "name": "FRED: T10Y3M",
  ...
  "stress": {
    "signals": [
      {
        ...
        "desc": "지수 낙폭. 이미 실현된 손실이라 레짐과 무관하게 절대기준으로 본다(백분위로 보면 '올해 내내 빠졌으니 정상'이라는 틀린 답이 나온다)."
      },
      {
        "key": "kosdaq_dd",
      ...
      },
      {
        ...
        "status": "safe",
        "status_ko": "정상",
        "threshold": "절대 30/45 + 자체분포 상위 40%/15%",
        "desc": "최근 62관측 범위 65.6~96.94 중 하위 27% — 절대·상대 판정이 엇갈려 약한 쪽(자체분포) 채택. 20일 전 대비 하락 -9.9. 한국 공포지수 — VIX(미국)로는 한국 국지적 급락이 안 잡힌다. 절대수준이 높아도 자체 분포에서 중하위면 추가 악화가 아니라 진정 국면."
      },
      {
        "key": "hy_oas",
        "name": "하이일드 스프레드",
        ...
        "status": "safe",
        "status_ko": "정상",
        "threshold": "절대 4.5/6.0 + 자체분포 상위 40%/15%",
        "desc": "최근 37관측 범위 2.68~4.42 중 하위 3%. 신용시장 스트레스. 주가 급락이 신용으로 번지면 실물 위기, 안 번지면 수급 이벤트 — 급락의 성격을 가르는 핵심 교차검증. ※ FRED가 ICE BofA를 최근 3년만 제공해 분포 표본이 짧다(그래서 절대기준 병용)."
      },
      {
        "key": "vix",
        "name": "VIX (미국 변동성)",
        ...
        "status": "safe",
        "status_ko": "정상",
        "threshold": "절대 25/35 + 자체분포 상위 40%/15%",
        "desc": "최근 120관측 범위 9.51~53.54 중 하위 30%. 미국 공포지수. 한국만 빠지고 VIX가 잠잠하면 글로벌 위기가 아니라 한국 국지 이슈라는 뜻."
      }
    ],
    "verdict": {
      "label": "스트레스 경보",
    ...
    "note": "레짐 점수(가중평균)와 별개로 운용되는 임계 경보 — 평균은 단일 급락을 희석하지만 이 패널은 임계를 넘는 순간 켜진다. 낙폭은 절대기준(실현 손실), 변동성·신용은 절대+자체분포 결합(둘 다 위험할 때만 상향)으로 판정한다. 한국(낙폭·VKOSPI)과 글로벌(HY·VIX)을 나란히 놓아 급락이 국지적인지 시스템적인지 판별."
  },
  "sector_rotation": {
    "regions": {
      "US": [
  ...
  "policy_rates": {
    ...
    "KR": {
      ...
      "chg6m": 0.219,
      "bias": -1,
      "src": "seed(>IRSTCI01KRM156N 2026-06)"
    },
    "EU": {
      "rate": 2.25,
      "as_of": "2026-08",
  ...
  "indicators": {
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 22.07 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-08-08",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 08/07 (1일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-08-07",
          "days_old": 1,
          "stale": false,
          "note": "FactSet Earnings Insight(08/07 발간) 기준 — CY2026 EPS 성장 +30.0%, CY2027 +13.6% 컨센서스. S&P500 bottom-up EPS, forward 12M ≈ $385.5(forward P/E 20.0·지수 7,709.96). 매주 금요일 자동 갱신.",
          "years": [
            {
              "y": 2020,
              "eps": 140.23,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (69일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (69일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 69,
          "stale": true,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 55.6(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.1%(호재)·비농업 고용 (전월비) -23.0천명(강한 악재)·장단기 금리차(10Y-2Y) 0.46%p(호재)·WTI 유가 (YoY) 15.5%(악재)",
    ...
    "overall": "종합 레짐 점수 +17. 매크로 +16, 밸류 -33, 수급 +55, 센티 +16, 기업이익 +31."
  },
  "outlook": {
    "short": {
      "bias": "상승",
