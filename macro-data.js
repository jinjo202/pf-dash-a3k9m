...
window.MACRO = {
  ...
  "generated": "2026-07-30T07:23:10Z",
  "regime": {
    "score": 27,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "signals": [
      {
        ...
        "status_ko": "안전",
        "threshold": "30% 이상 경고",
        "desc": "10Y-3M 스프레드 +0.84%p 기반 12개월 내 침체확률(Estrella-Mishkin probit). 역사상 30% 돌파 시 대부분 침체 선행.",
        "source": {
          "name": "FRED: T10Y3M",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -17.1·기관 +2.8·개인 +13.7(21일). 최근 26.07.30: 외국인 +1.34·기관 +0.07·개인 -1.43. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-30",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 17.67 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-30",
      "history": null,
      "source": {
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.45%p(호재)·WTI 유가 (YoY) 26.3%(강한 악재)",
    "valuation": "[완만한 호재 우위] S&P500 12M Fwd PER 17.7배(중립)·KOSPI 12M Fwd PER 3.4배(강한 호재)·주식위험프리미엄(ERP) 1.05%p(중립)·미국 10Y 금리 4.62%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.62%p(호재)·USD/KRW 1436.5원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 107.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -17.1조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 20.7(악재)·S&P500 12M 모멘텀 15.4%(강한 호재)·CNN 공포·탐욕 지수 32(강한 악재)·AAII 불-베어 스프레드 -11.1%p(호재)·CBOE 풋/콜 비율(총) 1.05(호재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.3%(유지)",
    "overall": "종합 레짐 점수 +27. 매크로 +7, 밸류 +12, 수급 +53, 센티 +18, 기업이익 +48."
  },
  "outlook": {
    "short": {
      "bias": "상승",
