...
window.MACRO = {
  ...
  "generated": "2026-07-27T10:39:06Z",
  "regime": {
    "score": 26,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 25.1%(강한 악재)",
