...
window.MACRO = {
  ...
  "generated": "2026-06-30T07:46:12Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1548.5원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 126.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -48.4조원(강한 악재)",
