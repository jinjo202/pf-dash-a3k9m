...
window.MACRO = {
  ...
  "generated": "2026-07-22T22:23:49Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 32.8조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-20",
      "history": {
        "dates": [
          "2024-05-01",
  ...
  "commentary": {
    ...
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1476.2원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 112.5조원(강한 호재)·한국 투자자별 수급(외국인, 월) -8.7조원(중립)",
