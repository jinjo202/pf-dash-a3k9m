...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-20T10:17:33Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 06/12 (8일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (20일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (20일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 20,
          "stale": true,
  ...
  "commentary": {
    ...
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.4(중립)·S&P500 12M 모멘텀 20.9%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +14. 매크로 -1, 밸류 -14, 수급 +15, 센티 +17, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
