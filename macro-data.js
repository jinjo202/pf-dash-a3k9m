...
window.MACRO = {
  ...
  "generated": "2026-07-13T07:23:05Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 36.1조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-09",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -14.0·기관 +0.3·개인 +13.2(9일). 최근 26.07.13: 외국인 -1.69·기관 -2.22·개인 +3.88. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-13",
      "history": null,
      "manual": true,
      "kind": "release",
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.35%p(호재)·WTI 유가 (YoY) 13.2%(악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 20.1배(강한 악재)·KOSPI 12M Fwd PER 4.7배(강한 호재)·주식위험프리미엄(ERP) 0.45%p(중립)·미국 10Y 금리 4.57%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.56%p(호재)·USD/KRW 1502.3원(중립)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 107.1조원(강한 호재)·한국 투자자별 수급(외국인, 월) -14.0조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 15.0(호재)·S&P500 12M 모멘텀 19.5%(강한 호재)·CNN 공포·탐욕 지수 49(중립)·AAII 불-베어 스프레드 -0.9%p(중립)·CBOE 풋/콜 비율(총) 0.81(악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.583(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.242(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +24. 매크로 +8, 밸류 -6, 수급 +41, 센티 +23, 기업이익 +51."
  },
  "outlook": {
    "short": {
      "bias": "상승",
