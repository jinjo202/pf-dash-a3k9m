...
window.MACRO = {
  ...
  "generated": "2026-07-30T01:06:11Z",
  "regime": {
    "score": 27,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -18.1·기관 +3.3·개인 +14.3(21일). 최근 26.07.30: 외국인 +0.34·기관 +0.50·개인 -0.83. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-30",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 17.97 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-30",
      "history": null,
      "source": {
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.45%p(호재)·WTI 유가 (YoY) 25.2%(강한 악재)",
    "valuation": "[완만한 호재 우위] S&P500 12M Fwd PER 18.0배(중립)·KOSPI 12M Fwd PER 3.3배(강한 호재)·주식위험프리미엄(ERP) 0.95%p(중립)·미국 10Y 금리 4.62%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.62%p(호재)·USD/KRW 1442.7원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 107.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -18.1조원(악재)",
