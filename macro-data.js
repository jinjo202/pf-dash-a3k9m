...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-18T11:58:16Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1538.9원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 124.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -20.0조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 17.4(중립)·S&P500 12M 모멘텀 19.6%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
