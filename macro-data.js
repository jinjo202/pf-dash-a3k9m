...
window.MACRO = {
  ...
  "generated": "2026-06-22T00:03:51Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 06/12 (9일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (21일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (21일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 21,
          "stale": true,
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1529.1원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 128.4조원(강한 호재)·한국 투자자별 수급(외국인, 월) -20.3조원(악재)",
    ...
    "overall": "종합 레짐 점수 +14. 매크로 -1, 밸류 -14, 수급 +15, 센티 +20, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
