...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-27T22:46:49Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 38.0조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-06-24",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -36.9·기관 -0.7·개인 +37.0(19일). 최근 26.06.26: 외국인 -4.29·기관 -4.12·개인 +8.19. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-27",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.5 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-27",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 06/12 (15일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (27일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (27일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 27,
          "stale": true,
      ...
      "US": [
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 1.253163178361616,
              "note": "AI칩 위탁생산 독점적"
            },
            {
              "ticker": "AVGO",
              "name": "Broadcom Inc.",
              "mktcap": 1736611856384,
              "fwdpe": 18.8,
              "pbr": 19.81,
              "rets": {
                "w1": -11.1,
              ...
              "rev30": 2.6147316234306217,
              "note": "맞춤형 AI칩(ASIC)·네트워킹"
            },
            {
              "ticker": "MU",
              "name": "Micron Technology, Inc.",
              "mktcap": 1278845648896,
              "fwdpe": 7.6,
              "pbr": 17.63,
              "rets": {
                "w1": -0.1,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 19.088921169057915,
              "note": "각형 배터리"
            },
            {
              "ticker": "051910.KS",
              "name": "LGCHEM",
              "mktcap": 21212554067968,
              "fwdpe": 10.6,
              "pbr": null,
              "rets": {
                "w1": -19.8,
          ...
          "holdings": [
            {
              ...
              "rev30": -0.023303010815467484,
              "note": "CDMO 증설"
            },
            {
              "ticker": "068270.KS",
              "name": "Celltrion",
              "mktcap": 38045382344704,
              "fwdpe": 23.0,
              "pbr": null,
              "rets": {
                "w1": -2.6,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) -3.5%(중립)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.5배(악재)·KOSPI 12M Fwd PER 6.5배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.45%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1535.0원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 136.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -36.9조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.4(중립)·S&P500 12M 모멘텀 18.5%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +16. 매크로 +3, 밸류 -4, 수급 +12, 센티 +17, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
