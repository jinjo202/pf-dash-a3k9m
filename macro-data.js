...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "0.93 → 0.93 (2026-07-16 발표)",
      "as_of": "2026-07-16"
    },
    {
      "date": "2026-07-16",
      ...
      "key": "krflow_26.07.16",
      "title": "한국 투자자 수급 갱신",
      "detail": "외국인 26.07.16 -0.83조 · YTD누적 -159.88조"
    },
    {
      "date": "2026-07-16",
      "type": "release",
  ...
  "generated": "2026-07-23T22:38:32Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -6.5·기관 +0.5·개인 +5.6(16일). 최근 26.07.23: 외국인 +2.14·기관 +0.10·개인 -2.21. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-23",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/17 (6일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (53일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (53일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 53,
          "stale": true,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.34%p(호재)·WTI 유가 (YoY) 34.7%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.3배(악재)·KOSPI 12M Fwd PER 4.7배(강한 호재)·주식위험프리미엄(ERP) 0.51%p(중립)·미국 10Y 금리 4.7%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.58%p(호재)·USD/KRW 1474.1원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 103.9조원(강한 호재)·한국 투자자별 수급(외국인, 월) -6.5조원(중립)",
    ...
    "overall": "종합 레짐 점수 +25. 매크로 +5, 밸류 +1, 수급 +49, 센티 +23, 기업이익 +48."
  },
  "outlook": {
    "short": {
      "bias": "상승",
