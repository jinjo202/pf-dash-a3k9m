...
window.MACRO = {
  ...
  "generated": "2026-06-19T00:55:11Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -20.8·기관 +3.3·개인 +17.3(14일). 최근 26.06.19: 외국인 -0.87·기관 -0.23·개인 +1.12. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-19",
      "history": null,
      "manual": true,
      "kind": "release",
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1535.7원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 124.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -20.8조원(악재)",
    ...
    "overall": "종합 레짐 점수 +14. 매크로 +0, 밸류 -15, 수급 +14, 센티 +20, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
