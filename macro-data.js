...
window.MACRO = {
  ...
  "update_log": [
    {
      ...
      "key": "oil_yoy",
      "title": "WTI 유가 (YoY)",
      "detail": "19.1% → 16.2% (2026-07-17 발표)",
      "as_of": "2026-07-17"
    },
    {
      "date": "2026-07-17",
    ...
    },
    {
      ...
      "detail": "41.9배 → 41.5배 (2026-07-17 발표)",
      "as_of": "2026-07-17"
    },
    {
      "date": "2026-07-17",
    ...
    },
    {
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "0.87 → 0.87 (2026-07-18 발표)",
      "as_of": "2026-07-18"
    },
    {
      "date": "2026-07-18",
  ...
  "updates_today": [],
  "generated": "2026-07-25T09:22:23Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 32.6조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-22",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -9.8·기관 -1.5·개인 +10.8(17일). 최근 26.07.24: 외국인 -3.27·기관 -1.95·개인 +5.18. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-25",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 07/10 (15일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (55일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (55일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 55,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": 7.718762486120245,
              "note": "주주환원·밸류업"
            },
            {
              "ticker": "055550.KS",
              "name": "ShinhanGroup",
              "mktcap": 49158236930048,
              "fwdpe": 7.8,
              "pbr": null,
              "rets": {
                "w1": -3.2,
              ...
              "rev30": 6.496680126660737,
              "note": "배당·NIM"
            },
            {
              "ticker": "086790.KS",
              "name": "HANAFINANCIALGR",
              "mktcap": 35519908020224,
              "fwdpe": 7.4,
              "pbr": null,
              "rets": {
                "w1": -3.2,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 33.3%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.0배(악재)·KOSPI 12M Fwd PER 4.3배(강한 호재)·주식위험프리미엄(ERP) 0.54%p(중립)·미국 10Y 금리 4.7%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.58%p(호재)·USD/KRW 1462.1원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 103.9조원(강한 호재)·한국 투자자별 수급(외국인, 월) -9.8조원(중립)",
    ...
    "overall": "종합 레짐 점수 +25. 매크로 +5, 밸류 +2, 수급 +50, 센티 +21, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
