...
window.MACRO = {
  ...
  "generated": "2026-06-24T01:59:14Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -28.4·기관 -1.3·개인 +29.3(17일). 최근 26.06.24: 외국인 -1.32·기관 +0.50·개인 +0.76. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-24",
      "history": null,
      "manual": true,
      "kind": "release",
  ...
  "commentary": {
    ...
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 20.2배(강한 악재)·KOSPI 12M Fwd PER 6.7배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.49%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1535.3원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 132.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -28.4조원(악재)",
