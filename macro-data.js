...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "key": "cape",
      "title": "S&P500 CAPE(실러 PE)",
      "detail": "41.9배 → 42.0배 (2026-07-14 발표)",
      "as_of": "2026-07-14"
    },
    {
      "date": "2026-07-14",
  ...
  "updates_today": [],
  "generated": "2026-07-20T10:30:56Z",
  "regime": {
    "score": 27,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "signals": [
      {
        ...
        "status_ko": "주의",
        "threshold": "30% 이상 경고",
        "desc": "10Y-3M 스프레드 +0.70%p 기반 12개월 내 침체확률(Estrella-Mishkin probit). 역사상 30% 돌파 시 대부분 침체 선행.",
        "source": {
          "name": "FRED: T10Y3M",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 33.9조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-15",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -11.6·기관 +0.4·개인 +10.7(13일). 최근 26.07.20: 외국인 +0.52·기관 -0.92·개인 +0.35. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-20",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "eps_rev_us": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.1%·90일 +5.3%. 그래프=90일 경로.",
      "as_of": "2026-07-20",
      "history": {
        "dates": [
          "90일전",
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "pos",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.1%·90일 +2.5%. 그래프=90일 경로.",
      "as_of": "2026-07-20",
      "history": {
        "dates": [
          "90일전",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.23 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-20",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/17 (3일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (50일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (50일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 50,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.2879419294787633,
              "note": "AI 가속기 사실상 독점·데이터센터 폭증"
            },
            {
              "ticker": "TSM",
              "name": "Taiwan Semiconductor Manufactur",
              "mktcap": 2066135646208,
              "fwdpe": 18.6,
              "pbr": 82.98,
              "rets": {
                "w1": -8.2,
              ...
              "rev30": 8.12340313003952,
              "note": "AI칩 위탁생산 독점적"
            },
            {
              "ticker": "AVGO",
              "name": "Broadcom Inc.",
              "mktcap": 1764229775360,
              "fwdpe": 19.1,
              "pbr": 20.12,
              "rets": {
                "w1": -7.3,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.15399743173611924,
              "note": "검색·Gemini·클라우드"
            },
            {
              "ticker": "META",
              "name": "Meta Platforms, Inc.",
              "mktcap": 1639846903808,
              "fwdpe": 17.8,
              "pbr": 6.73,
              "rets": {
                "w1": -3.5,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.3177266788848332,
              "note": "AWS·리테일 마진"
            },
            {
              "ticker": "TSLA",
              "name": "Tesla, Inc.",
              "mktcap": 1430329884672,
              "fwdpe": 149.1,
              "pbr": 17.39,
              "rets": {
                "w1": -6.6,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 5.828902500748123,
              "note": "각형 배터리"
            },
            {
              "ticker": "051910.KS",
              "name": "LGCHEM",
              "mktcap": 19803601371136,
              "fwdpe": 11.2,
              "pbr": null,
              "rets": {
                "w1": -4.2,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.37%p(호재)·WTI 유가 (YoY) 19.0%(악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.2배(악재)·KOSPI 12M Fwd PER 4.3배(강한 호재)·주식위험프리미엄(ERP) 0.63%p(중립)·미국 10Y 금리 4.54%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.59%p(호재)·USD/KRW 1481.3원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 109.9조원(강한 호재)·한국 투자자별 수급(외국인, 월) -11.6조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.4(중립)·S&P500 12M 모멘텀 17.6%(강한 호재)·CNN 공포·탐욕 지수 37(악재)·AAII 불-베어 스프레드 12.0%p(악재)·CBOE 풋/콜 비율(총) 0.97(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.328(강한 상향)·한국 Fwd EPS 수정(1개월) 0.6%(유지)",
    "overall": "종합 레짐 점수 +27. 매크로 +9, 밸류 +2, 수급 +49, 센티 +11, 기업이익 +57."
  },
  "outlook": {
    "short": {
      "bias": "상승",
