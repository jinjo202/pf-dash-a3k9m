...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-08T09:56:26Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 37.1조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-06",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -12.1·기관 +0.1·개인 +11.5(6일). 최근 26.07.08: 외국인 +0.34·기관 -0.36·개인 -0.04. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-08",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.4 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-08",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 06/12 (26일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (38일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (38일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 38,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": -160.4231835528662,
              "note": "전기차 둔화·ESS"
            },
            {
              "ticker": "006400.KS",
              "name": "SAMSUNG SDI CO.,LTD.",
              "mktcap": 32421776982016,
              "fwdpe": 24.0,
              "pbr": null,
              "rets": {
                "w1": -16.1,
          ...
          "holdings": [
            {
              ...
              "rev30": -1.718177578804081,
              "note": "광고·AI·웹툰"
            },
            {
              "ticker": "035720.KS",
              "name": "Kakao",
              "mktcap": 15269696110592,
              "fwdpe": 19.7,
              "pbr": null,
              "rets": {
                "w1": -0.4,
          ...
          "holdings": [
            {
              ...
              "rev30": -0.054065468660791094,
              "note": "중국 화장품 회복"
            },
            {
              "ticker": "271560.KS",
              "name": "ORION",
              "mktcap": 5545889103872,
              "fwdpe": 10.6,
              "pbr": null,
              "rets": {
                "w1": 2.6,
  ...
  "commentary": {
    "macro": "[부담 우위] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 14.3%(악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.4배(악재)·KOSPI 12M Fwd PER 5.0배(강한 호재)·주식위험프리미엄(ERP) 0.67%p(중립)·미국 10Y 금리 4.53%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.54%p(강한 호재)·USD/KRW 1507.4원(중립)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 112.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -12.1조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.6(중립)·S&P500 12M 모멘텀 18.4%(강한 호재)·CNN 공포·탐욕 지수 43(악재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.594(강한 상향)·미국 Fwd EPS 수정(1개월) 0.1%(유지)·한국 ERR(이익수정비율) 0.237(상향 우위)·한국 Fwd EPS 수정(1개월) 0.3%(유지)",
    "overall": "종합 레짐 점수 +16. 매크로 -15, 밸류 -1, 수급 +30, 센티 +10, 기업이익 +51."
  },
  "outlook": {
    "short": {
      "bias": "상승",
