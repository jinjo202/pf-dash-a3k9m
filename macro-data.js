...
window.MACRO = {
  ...
  "update_log": [
    {
      ...
      "key": "kr_deposit",
      "title": "한국 투자자예탁금",
      "detail": "108.1조원 → 112.5조원 (2026-07-20 발표)",
      "as_of": "2026-07-20"
    },
    {
      "date": "2026-07-22",
    ...
    },
    {
      ...
      "key": "krflow_26.07.22",
      "title": "한국 투자자 수급 갱신",
      "detail": "외국인 26.07.22 +1.63조 · YTD누적 -157.97조"
    },
    {
      "date": "2026-07-22",
      "type": "release",
      "key": "oil_yoy",
      "title": "WTI 유가 (YoY)",
      "detail": "23.7% → 30.1% (2026-07-22 발표)",
      "as_of": "2026-07-22"
    },
    {
      "date": "2026-07-22",
    ...
    },
    {
      ...
      "detail": "41.0배 → 40.9배 (2026-07-22 발표)",
      "as_of": "2026-07-22"
    },
    {
      "date": "2026-07-22",
    ...
    },
    {
      ...
      "key": "kr_deposit",
      "title": "한국 투자자예탁금",
      "detail": "112.5조원 → 106.7조원 (2026-07-21 발표)",
      "as_of": "2026-07-21"
    },
    {
      "date": "2026-07-23",
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "0.92 → 0.92 (2026-07-23 발표)",
      "as_of": "2026-07-23"
    },
    {
      "date": "2026-07-23",
      ...
      "key": "krflow_26.07.23",
      "title": "한국 투자자 수급 갱신",
      "detail": "외국인 26.07.23 +0.82조 · YTD누적 -156.16조"
    },
    {
      "date": "2026-07-23",
      "type": "release",
      "key": "oil_yoy",
      "title": "WTI 유가 (YoY)",
      "detail": "32.1% → 30.5% (2026-07-23 발표)",
      "as_of": "2026-07-23"
    },
    {
      "date": "2026-07-23",
    ...
    },
    {
      ...
      "detail": "12.0%p → -12.7%p (2026-07-22 발표)",
      "as_of": "2026-07-22"
    },
    {
      "date": "2026-07-23",
  ...
  "generated": "2026-07-29T09:25:42Z",
  "regime": {
    "score": 27,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "signals": [
      {
        ...
        "status_ko": "주의",
        "threshold": "30% 이상 경고",
        "desc": "10Y-3M 스프레드 +0.71%p 기반 12개월 내 침체확률(Estrella-Mishkin probit). 역사상 30% 돌파 시 대부분 침체 선행.",
        "source": {
          "name": "FRED: T10Y3M",
  ...
  "indicators": {
    ...
    "aaii_spread": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "AAII 개인투자자 설문: 강세 29.6%·중립 28.1%·약세 42.3%(역사평균 강세 37.5%). 역발상 지표 — 비관(음수)일수록 바닥 신호. aaii.com/sentimentsurvey 주간 갱신.",
      "as_of": "2026-07-22",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 32.3조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-27",
      "history": {
        "dates": [
          "2024-06-01",
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -18.4·기관 +2.8·개인 +15.1(20일). 최근 26.07.29: 외국인 -1.25·기관 +3.18·개인 -1.97. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-29",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "eps_rev_us": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.0%·90일 +4.4%. 그래프=90일 경로.",
      "as_of": "2026-07-29",
      "history": {
        "dates": [
          "90일전",
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.0%·90일 +0.9%. 그래프=90일 경로.",
      "as_of": "2026-07-29",
      "history": {
        "dates": [
          "90일전",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 18.61 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-29",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 07/10 (19일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (59일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (59일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 59,
          "stale": true,
      ...
      "US": [
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 6.283833826774599,
              "note": "AI칩 위탁생산 독점적"
            },
            {
              "ticker": "AVGO",
              "name": "Broadcom Inc.",
              "mktcap": 1812209860608,
              "fwdpe": 19.5,
              "pbr": 20.67,
              "rets": {
                "w1": 1.3,
          ...
          "holdings": [
            {
              ...
              "rev30": 44.73207188046258,
              "note": "검색·Gemini·클라우드"
            },
            {
              "ticker": "META",
              "name": "Meta Platforms, Inc.",
              "mktcap": 1506325692416,
              "fwdpe": 16.0,
              "pbr": 6.18,
              "rets": {
                "w1": -8.0,
          ...
          "holdings": [
            {
              ...
              "rev30": 3.1092609061568854,
              "note": "메모리·HBM·파운드리 턴"
            },
            {
              "ticker": "000660.KS",
              "name": "SK hynix",
              "mktcap": 994506723819520,
              "fwdpe": 3.1,
              "pbr": null,
              "rets": {
                "w1": -23.4,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 6.004650581636439,
              "note": "각형 배터리"
            },
            {
              "ticker": "051910.KS",
              "name": "LGCHEM",
              "mktcap": 18198961324032,
              "fwdpe": 10.3,
              "pbr": null,
              "rets": {
                "w1": -7.7,
          ...
          "holdings": [
            {
              ...
              "rev30": 1.3176292632136821,
              "note": "중국 화장품 회복"
            },
            {
              "ticker": "271560.KS",
              "name": "ORION",
              "mktcap": 5336386240512,
              "fwdpe": 10.1,
              "pbr": null,
              "rets": {
                "w1": 5.0,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.35%p(호재)·WTI 유가 (YoY) 21.4%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 18.6배(중립)·KOSPI 12M Fwd PER 3.5배(강한 호재)·주식위험프리미엄(ERP) 0.72%p(중립)·미국 10Y 금리 4.64%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.61%p(호재)·USD/KRW 1451.4원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 109.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -18.4조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.2(중립)·S&P500 12M 모멘텀 17.2%(강한 호재)·CNN 공포·탐욕 지수 40(악재)·AAII 불-베어 스프레드 -12.7%p(강한 호재)·CBOE 풋/콜 비율(총) 0.96(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.3%(유지)",
    "overall": "종합 레짐 점수 +27. 매크로 +6, 밸류 +6, 수급 +53, 센티 +21, 기업이익 +48."
  },
  "outlook": {
    "short": {
      "bias": "상승",
