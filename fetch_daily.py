...
UNIVERSE = {
    ...
    "europe": [
        ...
        ("RHM.DE", "라인메탈", "산업재"),
        ("MT.AS", "아르셀로미탈", "소재"),
        ("MBG.DE", "메르세데스벤츠", "경기소비재"),
        ("BAS.DE", "BASF", "소재"),
        ("RWE.DE", "RWE", "유틸리티"),
        ("VOW3.DE", "폭스바겐", "경기소비재"),
        ("BMW.DE", "BMW", "경기소비재"),
        ("UMG.AS", "유니버설뮤직", "커뮤니케이션"),
        ("DGE.L", "디아지오", "필수소비재"),
        ("ADS.DE", "아디다스", "경기소비재"),
        ("RKT.L", "레킷벤키저", "필수소비재"),
        ("SIKA.SW", "시카", "소재"),
    ...
    "china": [
        ...
        ("9618.HK", "JD닷컴", "경기소비재"),
        ("000858.SZ", "우량예", "필수소비재"),
        ("000651.SZ", "거리전기", "경기소비재"),
        ("2020.HK", "안타스포츠", "경기소비재"),
        ("0762.HK", "차이나유니콤", "커뮤니케이션"),
        ("601668.SS", "중국건축", "산업재"),
        ("1024.HK", "콰이쇼우", "커뮤니케이션"),
        ("2269.HK", "우시바이오", "헬스케어"),
        ("0688.HK", "중국해외발전", "부동산"),
    ...
    "korea": [
        ...
        ("055550.KS", "신한지주", "금융"),
        ("034020.KS", "두산에너빌리티", "산업재"),
        ("012450.KS", "한화에어로스페이스", "산업재"),
        ("012330.KS", "현대모비스", "경기소비재"),
        ("068270.KS", "셀트리온", "헬스케어"),
        ("034730.KS", "SK", "산업재"),
        ("086790.KS", "하나금융지주", "금융"),
        ("006400.KS", "삼성SDI", "경기소비재"),
        ("066570.KS", "LG전자", "정보기술"),
        ("267260.KS", "HD현대일렉트릭", "산업재"),
        ("035420.KS", "NAVER", "커뮤니케이션"),
        ("000810.KS", "삼성화재", "금융"),
        ("042660.KS", "한화오션", "산업재"),
        ("000150.KS", "두산", "산업재"),
        ("006800.KS", "미래에셋증권", "금융"),
        ("009540.KS", "HD한국조선해양", "산업재"),
        ...
        ("017670.KS", "SK텔레콤", "커뮤니케이션"),
        ("033780.KS", "KT&G", "필수소비재"),
        ("096770.KS", "SK이노베이션", "에너지"),
        ("024110.KS", "기업은행", "금융"),
        ("003550.KS", "LG", "정보기술"),
        ("035720.KS", "카카오", "커뮤니케이션"),
        ("018260.KS", "삼성에스디에스", "정보기술"),
        ("010950.KS", "S-Oil", "에너지"),
        ("267250.KS", "HD현대", "에너지"),
        ("071050.KS", "한국금융지주", "금융"),
        ("030200.KS", "KT", "커뮤니케이션"),
        ("259960.KS", "크래프톤", "커뮤니케이션"),
        ("352820.KS", "하이브", "커뮤니케이션"),
        ("161390.KS", "한국타이어앤테크놀로지", "경기소비재"),
        ("090430.KS", "아모레퍼시픽", "필수소비재"),
        ("326030.KS", "SK바이오팜", "헬스케어"),
        ("009830.KS", "한화솔루션", "정보기술"),
        ("034220.KS", "LG디스플레이", "정보기술"),
        ("271560.KS", "오리온", "필수소비재"),
        ("000100.KS", "유한양행", "헬스케어"),
        ("128940.KS", "한미약품", "헬스케어"),
        ("036570.KS", "엔씨소프트", "커뮤니케이션"),
        ("011790.KS", "SKC", "소재"),
        ("023530.KS", "롯데쇼핑", "경기소비재"),
        ("051900.KS", "LG생활건강", "필수소비재"),
        ("069960.KS", "현대백화점", "경기소비재"),
        ("251270.KS", "넷마블", "커뮤니케이션"),
        ("097950.KS", "CJ제일제당", "필수소비재"),
        ("011170.KS", "롯데케미칼", "소재"),
        ("139480.KS", "이마트", "필수소비재"),
        ("004370.KS", "농심", "필수소비재"),
        ("330590.KS", "롯데리츠", "부동산"),
