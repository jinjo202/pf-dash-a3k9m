...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-22T13:02:55Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 21.23 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-22",
      "history": null,
      "source": {
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1537.1원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 128.4조원(강한 호재)·한국 투자자별 수급(외국인, 월) -22.9조원(악재)",
    ...
    "overall": "종합 레짐 점수 +14. 매크로 +0, 밸류 -15, 수급 +14, 센티 +19, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
