...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-03T23:18:58Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "sentiment": "[혼조/중립] VIX 변동성 15.8(호재)·S&P500 12M 모멘텀 18.0%(강한 호재)·CNN 공포·탐욕 지수 32(강한 악재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.453(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(둔화)",
    "overall": "종합 레짐 점수 +14. 매크로 +1, 밸류 -5, 수급 +17, 센티 +6, 기업이익 +45."
  },
  "outlook": {
    "short": {
      "bias": "상승",
