...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-22T13:37:22Z",
  "regime": {
    "score": 14,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 37.4조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-06-18",
      "history": {
        "dates": [
          "2024-04-01",
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -22.9·기관 +2.6·개인 +20.0(15일). 최근 26.06.22: 외국인 -2.55·기관 +0.30·개인 +2.15. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-22",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 21.23 / EPS성장 15%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-22",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 06/12 (10일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (22일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (22일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 22,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": -0.0704859312751549,
              "note": "검색·Gemini·클라우드"
            },
            {
              "ticker": "META",
              "name": "Meta Platforms, Inc.",
              "mktcap": 1450505797632,
              "fwdpe": 15.8,
              "pbr": 5.95,
              "rets": {
                "w1": 0.7,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.5683803192075843,
              "note": "AWS·리테일 마진"
            },
            {
              "ticker": "TSLA",
              "name": "Tesla, Inc.",
              "mktcap": 1494157230080,
              "fwdpe": 159.1,
              "pbr": 18.17,
              "rets": {
                "w1": -2.2,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) 14.9%(악재)",
    "valuation": "[부담 우위] S&P500 12M Fwd PER 21.2배(강한 악재)·KOSPI 12M Fwd PER 7.4배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.49%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1537.3원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 128.4조원(강한 호재)·한국 투자자별 수급(외국인, 월) -22.9조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 17.1(중립)·S&P500 12M 모멘텀 20.9%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.525(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +14. 매크로 +0, 밸류 -15, 수급 +14, 센티 +19, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
