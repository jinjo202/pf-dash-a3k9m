...
window.MACRO = {
  ...
  "generated": "2026-07-13T22:37:38Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.58%p(호재)·USD/KRW 1497.0원(중립)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 105.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -14.0조원(중립)",
    ...
    "overall": "종합 레짐 점수 +24. 매크로 +7, 밸류 -3, 수급 +45, 센티 +17, 기업이익 +51."
  },
  "outlook": {
    "short": {
      "bias": "상승",
