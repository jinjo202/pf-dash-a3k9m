...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-28T02:20:02Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.9(중립)·S&P500 12M 모멘텀 18.5%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +16. 매크로 +3, 밸류 -4, 수급 +12, 센티 +16, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
