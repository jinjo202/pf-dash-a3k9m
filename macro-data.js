...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "key": "cape",
      "title": "S&P500 CAPE(실러 PE)",
      "detail": "40.6배 → 41.0배 (2026-07-21 발표)",
      "as_of": "2026-07-21"
    },
    {
      "date": "2026-07-21",
  ...
  "generated": "2026-07-28T22:41:35Z",
  "regime": {
    "score": 26,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -17.2·기관 -0.4·개인 +17.1(19일). 최근 26.07.28: 외국인 -4.50·기관 +0.18·개인 +4.32. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-28",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 07/10 (18일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (58일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (58일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 58,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": 3.4896779517114895,
              "note": "메모리·HBM·파운드리 턴"
            },
            {
              "ticker": "000660.KS",
              "name": "SK hynix",
              "mktcap": 1100275125321728,
              "fwdpe": 3.4,
              "pbr": null,
              "rets": {
                "w1": -15.6,
          ...
          "holdings": [
            {
              ...
              "rev30": 7.511440540317227,
              "note": "주주환원·밸류업"
            },
            {
              "ticker": "055550.KS",
              "name": "ShinhanGroup",
              "mktcap": 47510215196672,
              "fwdpe": 7.5,
              "pbr": null,
              "rets": {
                "w1": -3.6,
          ...
          "holdings": [
            {
              ...
              "rev30": 1.1163904490073984,
              "note": "배당·AI/IDC"
            },
            {
              "ticker": "030200.KS",
              "name": "KT",
              "mktcap": 12835304243200,
              "fwdpe": 8.5,
              "pbr": null,
              "rets": {
                "w1": 3.4,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.35%p(호재)·WTI 유가 (YoY) 24.5%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 18.6배(중립)·KOSPI 12M Fwd PER 3.8배(강한 호재)·주식위험프리미엄(ERP) 0.72%p(중립)·미국 10Y 금리 4.6%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.61%p(호재)·USD/KRW 1453.7원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 109.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -17.2조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.2(중립)·S&P500 12M 모멘텀 17.2%(강한 호재)·CNN 공포·탐욕 지수 38(악재)·AAII 불-베어 스프레드 -12.7%p(강한 호재)·CBOE 풋/콜 비율(총) 0.94(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.3%(유지)",
    "overall": "종합 레짐 점수 +26. 매크로 +6, 밸류 +6, 수급 +53, 센티 +19, 기업이익 +48."
  },
  "outlook": {
    "short": {
      "bias": "상승",
