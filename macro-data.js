...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-26T02:19:33Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -34.8·기관 +3.2·개인 +31.1(19일). 최근 26.06.26: 외국인 -2.17·기관 -0.23·개인 +2.33. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-26",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.82 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-26",
      "history": null,
      "source": {
  ...
  "commentary": {
    ...
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.8배(악재)·KOSPI 12M Fwd PER 6.8배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.39%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1547.2원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 136.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -34.8조원(악재)",
    ...
    "overall": "종합 레짐 점수 +16. 매크로 +3, 밸류 -6, 수급 +12, 센티 +16, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
