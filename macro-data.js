...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-18T09:01:10Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "eps_rev_us": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.1%·90일 +3.6%. 그래프=90일 경로.",
      "as_of": "2026-07-18",
      "history": {
        "dates": [
          "90일전",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.23 / EPS성장 21%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-18",
      "history": null,
      "source": {
  ...
  "commentary": {
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.488(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.328(강한 상향)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +25. 매크로 +8, 밸류 +4, 수급 +47, 센티 +11, 기업이익 +50."
  },
  "outlook": {
    "short": {
      "bias": "상승",
