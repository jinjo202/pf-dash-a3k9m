...
window.MACRO = {
  ...
  "generated": "2026-07-01T00:37:55Z",
  "regime": {
    "score": 18,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -0.3·기관 +0.4·개인 -0.0(1일). 최근 26.07.01: 외국인 -0.32·기관 +0.36·개인 -0.04. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-01",
      "history": null,
      "manual": true,
      "kind": "release",
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1551.3원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 132.5조원(강한 호재)·한국 투자자별 수급(외국인, 월) -0.3조원(중립)",
