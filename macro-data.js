...
window.MACRO = {
  ...
  "generated": "2026-07-23T01:17:43Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -7.8·기관 +0.4·개인 +7.0(16일). 최근 26.07.23: 외국인 +0.82·기관 +0.01·개인 -0.82. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-23",
      "history": null,
      "manual": true,
      "kind": "release",
  ...
  "commentary": {
    ...
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1470.6원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 106.7조원(강한 호재)·한국 투자자별 수급(외국인, 월) -7.8조원(중립)",
    ...
    "overall": "종합 레짐 점수 +24. 매크로 +6, 밸류 -1, 수급 +49, 센티 +12, 기업이익 +50."
  },
  "outlook": {
    "short": {
      "bias": "상승",
