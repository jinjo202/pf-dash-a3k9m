...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-04T01:46:15Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.486(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(둔화)",
    "overall": "종합 레짐 점수 +15. 매크로 +1, 밸류 -5, 수급 +17, 센티 +6, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
