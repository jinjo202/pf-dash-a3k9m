...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "0.96 → 0.96 (2026-07-15 발표)",
      "as_of": "2026-07-15"
    },
    {
      "date": "2026-07-15",
      ...
      "key": "krflow_26.07.15",
      "title": "한국 투자자 수급 갱신",
      "detail": "외국인 26.07.15 +0.83조 · YTD누적 -160.53조"
    },
    {
      "date": "2026-07-15",
      "type": "release",
      "key": "oil_yoy",
      "title": "WTI 유가 (YoY)",
      "detail": "19.2% → 19.7% (2026-07-15 발표)",
      "as_of": "2026-07-15"
    },
    {
      "date": "2026-07-15",
  ...
  "generated": "2026-07-22T22:41:02Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "aaii_spread": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "AAII 개인투자자 설문: 강세 44.9%·중립 22.2%·약세 32.9%(역사평균 강세 37.5%). 역발상 지표 — 비관(음수)일수록 바닥 신호. aaii.com/sentimentsurvey 주간 갱신.",
      "as_of": "2026-07-15",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -8.7·기관 +0.4·개인 +7.8(15일). 최근 26.07.22: 외국인 +2.62·기관 -1.40·개인 -1.22. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-22",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "eps_rev_us": {
      ...
      "signal": "가속",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 가속). 7일 +0.2%·90일 +5.0%. 그래프=90일 경로.",
      "as_of": "2026-07-22",
      "history": {
        "dates": [
          "90일전",
    ...
    "eps_rev_kr": {
      ...
      "signal": "둔화",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 둔화). 7일 +0.0%·90일 +1.9%. 그래프=90일 경로.",
      "as_of": "2026-07-22",
      "history": {
        "dates": [
          "90일전",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/17 (5일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (52일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (52일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 52,
          "stale": true,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 32.4%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 19.7배(악재)·KOSPI 12M Fwd PER 4.5배(강한 호재)·주식위험프리미엄(ERP) 0.44%p(중립)·미국 10Y 금리 4.66%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1476.3원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 106.7조원(강한 호재)·한국 투자자별 수급(외국인, 월) -8.7조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 16.6(중립)·S&P500 12M 모멘텀 18.3%(강한 호재)·CNN 공포·탐욕 지수 43(악재)·AAII 불-베어 스프레드 12.0%p(악재)·CBOE 풋/콜 비율(총) 0.92(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(가속)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(둔화)",
    "overall": "종합 레짐 점수 +24. 매크로 +6, 밸류 -1, 수급 +48, 센티 +12, 기업이익 +52."
  },
  "outlook": {
    "short": {
      "bias": "상승",
