...
window.MACRO = {
  ...
  "generated": "2026-06-13T06:55:51Z",
  "regime": {
    "score": 13,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -25.1·기관 +0.3·개인 +24.1(8일). 최근 26.06.11: 외국인 -1.46·기관 -0.76·개인 +2.08. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-12",
      "history": null,
      "manual": true,
      "source": {
    ...
    "eps_rev_us": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.1%·90일 +3.1%. 그래프=90일 경로.",
      "as_of": "2026-06-13",
      "history": {
        "dates": [
          "90일전",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 20.77 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-13",
      "history": null,
      "source": {
          ...
          "holdings": [
            {
              ...
              "rev30": 0.09095827849574523,
              "note": "하이브리드·환율수혜"
            },
            {
              "ticker": "000270.KS",
              "name": "KIA CORP.",
              "mktcap": 64827825324032,
              "fwdpe": 7.1,
              "pbr": null,
              "rets": {
                "w1": 3.5,
  ...
  "commentary": {
    "macro": "[부담 우위] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) 36.5%(강한 악재)",
    "valuation": "[부담 우위] S&P500 12M Fwd PER 20.8배(강한 악재)·KOSPI 12M Fwd PER 5.9배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.46%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1516.0원(중립)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 95조원(강한 호재)·한국 투자자별 수급(외국인, 월) -25.1조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 19.4(중립)·S&P500 12M 모멘텀 19.8%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.292(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +13. 매크로 -10, 밸류 -11, 수급 +22, 센티 +15, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
    ...
    "mid": {
      "bias": "완만한 상승",
      "cls": "pos",
      "text": "매크로·유동성·기업이익 수정 + 과거 유사국면 이후 3개월 중간값 -2.0%."
    },
    "long": {
      "bias": "상승",
      "cls": "pos",
      "text": "밸류에이션·매크로 추세·이익 모멘텀 + 유사국면 이후 12개월 중간값 +14.2%."
    }
  },
  "real_rate": 0.81
};
