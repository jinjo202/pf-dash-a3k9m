...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-04T10:05:58Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "eps_rev_kr": {
      ...
      "signal": "둔화",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 둔화). 7일 +0.0%·90일 +2.2%. 그래프=90일 경로.",
      "as_of": "2026-07-04",
      "history": {
        "dates": [
          "90일전",
  ...
  "commentary": {
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.486(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.279(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(둔화)",
