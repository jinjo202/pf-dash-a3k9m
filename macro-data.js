...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-25T08:35:58Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 -0.1%·90일 +1.1%. 그래프=90일 경로.",
      "as_of": "2026-07-25",
      "history": {
        "dates": [
          "90일전",
  ...
  "commentary": {
    ...
    "overall": "종합 레짐 점수 +25. 매크로 +5, 밸류 +2, 수급 +50, 센티 +21, 기업이익 +48."
  },
  "outlook": {
    "short": {
      "bias": "상승",
