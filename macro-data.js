...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-22T09:40:20Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.78 / EPS성장 19%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-22",
      "history": null,
      "source": {
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.37%p(호재)·WTI 유가 (YoY) 32.1%(강한 악재)",
    ...
    "sentiment": "[완만한 호재 우위] VIX 변동성 17.3(중립)·S&P500 12M 모멘텀 18.5%(강한 호재)·CNN 공포·탐욕 지수 41(악재)·AAII 불-베어 스프레드 12.0%p(악재)·CBOE 풋/콜 비율(총) 0.92(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +24. 매크로 +7, 밸류 -1, 수급 +47, 센티 +10, 기업이익 +52."
  },
  "outlook": {
    "short": {
      "bias": "상승",
