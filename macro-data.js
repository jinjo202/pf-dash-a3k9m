...
window.MACRO = {
  ...
  "generated": "2026-07-16T07:23:06Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "signals": [
      {
        ...
        "status_ko": "주의",
        "threshold": "30% 이상 경고",
        "desc": "10Y-3M 스프레드 +0.72%p 기반 12개월 내 침체확률(Estrella-Mishkin probit). 역사상 30% 돌파 시 대부분 침체 선행.",
        "source": {
          "name": "FRED: T10Y3M",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 34.2조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-14",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -12.1·기관 +1.4·개인 +10.3(12일). 최근 26.07.16: 외국인 -1.38·기관 -2.37·개인 +3.66. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-16",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 20.07 / EPS성장 18%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-16",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/10 (6일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (46일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (46일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 46,
          "stale": true,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.10460239100966717,
              "note": "온디바이스 AI·서비스"
            },
            {
              "ticker": "MSFT",
              "name": "Microsoft Corporation",
              "mktcap": 2938911850496,
              "fwdpe": 20.4,
              "pbr": 7.09,
              "rets": {
                "w1": 3.2,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.009910377852473395,
              "note": "검색·Gemini·클라우드"
            },
            {
              "ticker": "META",
              "name": "Meta Platforms, Inc.",
              "mktcap": 1729453228032,
              "fwdpe": 18.8,
              "pbr": 7.1,
              "rets": {
                "w1": 13.0,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.24863338371532429,
              "note": "AWS·리테일 마진"
            },
            {
              "ticker": "TSLA",
              "name": "Tesla, Inc.",
              "mktcap": 1481482829824,
              "fwdpe": 154.4,
              "pbr": 18.01,
              "rets": {
                "w1": 0.1,
          ...
          "holdings": [
            {
              ...
              "rev30": -1.7794957095563335,
              "note": "하이브리드·환율수혜"
            },
            {
              "ticker": "000270.KS",
              "name": "KIA CORP.",
              "mktcap": 58181808029696,
              "fwdpe": 6.3,
              "pbr": null,
              "rets": {
                "w1": 3.4,
          ...
          "holdings": [
            {
              ...
              "rev30": 1.1017147174130715,
              "note": "CDMO 증설"
            },
            {
              "ticker": "068270.KS",
              "name": "Celltrion",
              "mktcap": 40315721351168,
              "fwdpe": 24.1,
              "pbr": null,
              "rets": {
                "w1": 1.6,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.42%p(호재)·WTI 유가 (YoY) 19.5%(악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 20.1배(강한 악재)·KOSPI 12M Fwd PER 4.5배(강한 호재)·주식위험프리미엄(ERP) 0.4%p(중립)·미국 10Y 금리 4.54%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.6%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1477.0원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 111.3조원(강한 호재)·한국 투자자별 수급(외국인, 월) -12.1조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 15.7(호재)·S&P500 12M 모멘텀 19.4%(강한 호재)·CNN 공포·탐욕 지수 47(중립)·AAII 불-베어 스프레드 12.0%p(악재)·CBOE 풋/콜 비율(총) 0.93(중립)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.228(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +25. 매크로 +9, 밸류 -3, 수급 +50, 센티 +19, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
