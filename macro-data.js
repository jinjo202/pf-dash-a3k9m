...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-18T08:28:08Z",
  "regime": {
    "score": 25,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.23 / EPS성장 17%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-18",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/17 (1일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (48일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (48일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 48,
          "stale": true,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.37%p(호재)·WTI 유가 (YoY) 21.4%(강한 악재)",
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.537(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.328(강한 상향)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +25. 매크로 +8, 밸류 +1, 수급 +47, 센티 +11, 기업이익 +53."
  },
  "outlook": {
    "short": {
      "bias": "상승",
