...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-30T10:01:33Z",
  "regime": {
    "score": 28,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.0%·90일 +1.0%. 그래프=90일 경로.",
      "as_of": "2026-07-30",
      "history": {
        "dates": [
          "90일전",
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.45%p(호재)·WTI 유가 (YoY) 24.8%(강한 악재)",
    "valuation": "[완만한 호재 우위] S&P500 12M Fwd PER 17.7배(중립)·KOSPI 12M Fwd PER 3.4배(강한 호재)·주식위험프리미엄(ERP) 1.05%p(중립)·미국 10Y 금리 4.62%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.62%p(호재)·USD/KRW 1434.8원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 107.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -17.1조원(악재)",
