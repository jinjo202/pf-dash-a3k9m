...
window.MACRO = {
  ...
  "generated": "2026-07-02T02:16:58Z",
  "regime": {
    "score": 18,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 36.7조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-06-30",
      "history": {
        "dates": [
          "2024-05-01",
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -5.5·기관 +1.3·개인 +4.1(2일). 최근 26.07.02: 외국인 -3.80·기관 +1.36·개인 +2.35. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-02",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 19.96 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-07-02",
      "history": null,
      "source": {
      ...
      "US": [
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 2.5921424605980015,
              "note": "맞춤형 AI칩(ASIC)·네트워킹"
            },
            {
              "ticker": "MU",
              "name": "Micron Technology, Inc.",
              "mktcap": 1165850050560,
              "fwdpe": 6.9,
              "pbr": 16.07,
              "rets": {
                "w1": -1.5,
          ...
          "holdings": [
            {
              ...
              "rev30": -0.06905776545088615,
              "note": "검색·Gemini·클라우드"
            },
            {
              "ticker": "META",
              "name": "Meta Platforms, Inc.",
              "mktcap": 1555824902144,
              "fwdpe": 16.9,
              "pbr": 6.38,
              "rets": {
                "w1": 9.9,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.22622576544921724,
              "note": "AWS·리테일 마진"
            },
            {
              "ticker": "TSLA",
              "name": "Tesla, Inc.",
              "mktcap": 1597309321216,
              "fwdpe": 170.0,
              "pbr": 19.42,
              "rets": {
                "w1": 13.3,
          ...
          "holdings": [
            {
              ...
              "rev30": 3.0913214450404736,
              "note": "메모리·HBM·파운드리 턴"
            },
            {
              "ticker": "000660.KS",
              "name": "SK hynix",
              "mktcap": 1712170056286208,
              "fwdpe": 5.5,
              "pbr": null,
              "rets": {
                "w1": -17.3,
          ...
          "holdings": [
            {
              ...
              "rev30": 1.3784983406445184,
              "note": "주주환원·밸류업"
            },
            {
              "ticker": "055550.KS",
              "name": "ShinhanGroup",
              "mktcap": 48922806452224,
              "fwdpe": 8.0,
              "pbr": null,
              "rets": {
                "w1": 9.9,
              ...
              "rev30": 0.7391237177136523,
              "note": "배당·NIM"
            },
            {
              "ticker": "086790.KS",
              "name": "HANAFINANCIALGR",
              "mktcap": 33293206552576,
              "fwdpe": 7.0,
              "pbr": null,
              "rets": {
                "w1": 8.9,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) -9.6%(호재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 20.0배(악재)·KOSPI 12M Fwd PER 5.9배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.47%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1554.1원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 121.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -5.5조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 16.6(중립)·S&P500 12M 모멘텀 18.0%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.541(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.4%(유지)",
    "overall": "종합 레짐 점수 +18. 매크로 +5, 밸류 -6, 수급 +17, 센티 +20, 기업이익 +49."
  },
  "outlook": {
    "short": {
      "bias": "상승",
