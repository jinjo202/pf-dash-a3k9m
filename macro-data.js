...
window.MACRO = {
  ...
  "generated": "2026-07-06T00:02:46Z",
  "regime": {
    "score": 16,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 06/12 (23일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (35일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (35일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 35,
          "stale": true,
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1542.1원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 119.9조원(강한 호재)·한국 투자자별 수급(외국인, 월) -8.2조원(중립)",
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.596(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.269(상향 우위)·한국 Fwd EPS 수정(1개월) 0.5%(유지)",
    "overall": "종합 레짐 점수 +16. 매크로 +1, 밸류 -5, 수급 +17, 센티 +5, 기업이익 +51."
  },
  "outlook": {
    "short": {
      "bias": "상승",
