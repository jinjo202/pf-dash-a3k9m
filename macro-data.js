...
window.MACRO = {
  ...
  "update_log": [
    {
      ...
      "key": "put_call",
      "title": "CBOE 풋/콜 비율(총)",
      "detail": "1.01 → 1.01 (2026-07-24 발표)",
      "as_of": "2026-07-24"
    },
    {
      "date": "2026-07-24",
      ...
      "key": "krflow_26.07.24",
      "title": "한국 투자자 수급 갱신",
      "detail": "외국인 26.07.24 -0.88조 · YTD누적 -155.73조"
    },
    {
      "date": "2026-07-24",
      "type": "release",
      "key": "oil_yoy",
      "title": "WTI 유가 (YoY)",
      "detail": "33.9% → 35.3% (2026-07-24 발표)",
      "as_of": "2026-07-24"
    },
    {
      "date": "2026-07-24",
  ...
  "updates_today": [],
  "generated": "2026-07-31T23:30:41Z",
  "regime": {
    "score": 29,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "pos",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.2%·90일 +1.5%. 그래프=90일 경로.",
      "as_of": "2026-07-31",
      "history": {
        "dates": [
          "90일전",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/31 (0일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (61일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (61일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 61,
          "stale": true,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) 29.2%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 18.9배(악재)·KOSPI 12M Fwd PER 4.3배(강한 호재)·주식위험프리미엄(ERP) 0.62%p(중립)·미국 10Y 금리 4.75%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.64%p(호재)·USD/KRW 1442.1원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 109.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -9.9조원(중립)",
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.3%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 1.0%(유지)",
    "overall": "종합 레짐 점수 +29. 매크로 +14, 밸류 +3, 수급 +54, 센티 +22, 기업이익 +49."
  },
  "outlook": {
    "short": {
      "bias": "상승",
