...
window.MACRO = {
  ...
  "generated": "2026-07-30T22:22:43Z",
  "regime": {
    "score": 29,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_deposit": {
      ...
      "signal": "강한 호재",
      "signal_cls": "pos",
      "desc": "증시 대기자금(고객예탁금). 신용잔고 32.7조 동반. 자동수집(네이버 증시자금추이). 예탁금 증가=매수 여력 확대. 카드 클릭→누적 추이.",
      "as_of": "2026-07-28",
      "history": {
        "dates": [
          "2024-06-01",
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -17.1·기관 +2.8·개인 +13.7(21일). 최근 26.07.30: 외국인 +1.33·기관 +0.08·개인 -1.43. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-30",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "eps_rev_us": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.0%·90일 +4.5%. 그래프=90일 경로.",
      "as_of": "2026-07-30",
      "history": {
        "dates": [
          "90일전",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · FactSet Earnings Insight · EPS 기준 07/10 (20일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (60일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (60일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 60,
          "stale": true,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.45%p(호재)·WTI 유가 (YoY) 25.0%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 18.6배(중립)·KOSPI 12M Fwd PER 3.4배(강한 호재)·주식위험프리미엄(ERP) 0.7%p(중립)·미국 10Y 금리 4.66%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1421.7원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 107.2조원(강한 호재)·한국 투자자별 수급(외국인, 월) -17.1조원(악재)",
    ...
    "overall": "종합 레짐 점수 +29. 매크로 +14, 밸류 +5, 수급 +53, 센티 +21, 기업이익 +49."
  },
  "outlook": {
    "short": {
      "bias": "상승",
