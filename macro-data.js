...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-18T00:21:00Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    ...
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1511.0원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 124.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -21.2조원(악재)",
    ...
    "overall": "종합 레짐 점수 +15. 매크로 -1, 밸류 -11, 수급 +20, 센티 +17, 기업이익 +45."
  },
  "outlook": {
    "short": {
      "bias": "상승",
