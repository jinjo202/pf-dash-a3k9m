...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-07-13T23:07:23Z",
  "regime": {
    "score": 24,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.36%p(호재)·WTI 유가 (YoY) 19.9%(악재)",
    ...
    "overall": "종합 레짐 점수 +24. 매크로 +7, 밸류 -3, 수급 +45, 센티 +17, 기업이익 +53."
  },
  "outlook": {
    "short": {
      "bias": "상승",
