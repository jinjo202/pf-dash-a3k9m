...
// 주: asOfPrice는 KR 종가일(7/16) 기준 (7/17 KR 종가 미확보 = 무세션, NAV·가격 불변). 미국 레그(TSM·INTC·WMT·TGT·^GSPC)는 7/15 종가 반영(아시아 마감 스냅샷) — 7/16 US 종가(TSM 409.74·INTC 96.98·WMT 114.95·TGT 140.21·^GSPC 7533.77)는 다음 KR 세션에 마킹 대기.
// ============================================================
window.PORTFOLIO_DATA = {
  ...
  // ================= 전략 A: 마켓 뉴트럴 =================
  {
    ...
    meta: {
      ...
      usdkrw: 1479.77,
      phase: "빌드업 Phase 1 — 페어 5개 / Gross 37% (목표 12~20개 / 180~200%) · 7/17 KR 무세션(종가 미확보), NAV 100.23 불변",
  ...
  // ================= 전략 B: 디렉셔널 L/S =================
  {
    ...
    meta: {
      ...
      lastUpdated: "2026-07-17",
      usdkrw: 1479.77,
      phase: "레짐: 중립(Neutral) — 넷 +42% / β 0.43 · 7/17 KR 무세션(종가 미확보)으로 NAV 97.40 불변·익일 재판정, 신호 불변(VIX 16.7·S&P 강세·KOSPI 중립), 하방 트리거 전부 미발동",
