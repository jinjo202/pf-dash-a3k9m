...
window.MACRO = {
  ...
  "generated": "2026-06-24T23:19:40Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "악재",
      "signal_cls": "neg",
      "desc": "2026.06 KOSPI 누적(조원): 외국인 -31.7·기관 +0.1·개인 +31.2(17일). 최근 26.06.24: 외국인 -4.65·기관 +1.91·개인 +2.63. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-06-24",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 20.12 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-24",
      "history": null,
      "source": {
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 06/12 (12일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (24일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (24일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 24,
          "stale": true,
      ...
      "US": [
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 2.6071396412700176,
              "note": "맞춤형 AI칩(ASIC)·네트워킹"
            },
            {
              "ticker": "MU",
              "name": "Micron Technology, Inc.",
              "mktcap": 1182440357888,
              "fwdpe": 8.6,
              "pbr": 16.32,
              "rets": {
                "w1": 2.7,
          ...
          "holdings": [
            {
              ...
              "rev30": 0.21373477226491744,
              "note": "AWS·리테일 마진"
            },
            {
              "ticker": "TSLA",
              "name": "Tesla, Inc.",
              "mktcap": 1410386886656,
              "fwdpe": 150.2,
              "pbr": 17.15,
              "rets": {
                "w1": -7.2,
          ...
          "holdings": [
            {
              ...
              "rev30": 3.472299925460609,
              "note": "메모리·HBM·파운드리 턴"
            },
            {
              "ticker": "000660.KS",
              "name": "SK hynix",
              "mktcap": 1831425728839680,
              "fwdpe": 6.1,
              "pbr": null,
              "rets": {
                "w1": 4.0,
          ...
          "holdings": [
            {
              ...
              "rev30": -1.675051394448368,
              "note": "광고·AI·웹툰"
            },
            {
              "ticker": "035720.KS",
              "name": "Kakao",
              "mktcap": 14983251361792,
              "fwdpe": 19.3,
              "pbr": null,
              "rets": {
                "w1": -16.2,
          ...
          "holdings": [
            {
              ...
              "rev30": -1.5646626367582073,
              "note": "CDMO 증설"
            },
            {
              "ticker": "068270.KS",
              "name": "Celltrion",
              "mktcap": 39604807794688,
              "fwdpe": 23.9,
              "pbr": null,
              "rets": {
                "w1": -1.1,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": -0.20756134610641075,
              "note": "아티스트 IP"
            },
            {
              "ticker": "041510.KQ",
              "name": "SME",
              "mktcap": 1616365092864,
              "fwdpe": 10.2,
              "pbr": null,
              "rets": {
                "w1": -14.1,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 0.42140626006310633,
              "note": "비철·동제련"
            },
            {
              "ticker": "004020.KS",
              "name": "HYUNDAI STEEL",
              "mktcap": 3821403635712,
              "fwdpe": 7.7,
              "pbr": null,
              "rets": {
                "w1": -16.8,
        ...
        },
        {
          ...
          "holdings": [
            ...
            },
            {
              ...
              "rev30": 0.5006404369732209,
              "note": "제과·내수"
            },
            {
              "ticker": "097950.KS",
              "name": "CJ CheilJedang",
              "mktcap": 3044404887552,
              "fwdpe": 6.6,
              "pbr": null,
              "rets": {
                "w1": -3.7,
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) 2.6%(중립)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 20.1배(강한 악재)·KOSPI 12M Fwd PER 6.7배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.4%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1539.6원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 136.8조원(강한 호재)·한국 투자자별 수급(외국인, 월) -31.7조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 18.6(중립)·S&P500 12M 모멘텀 18.6%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.1%(유지)",
    "overall": "종합 레짐 점수 +15. 매크로 +2, 밸류 -7, 수급 +13, 센티 +17, 기업이익 +46."
  },
  "outlook": {
    "short": {
      "bias": "상승",
