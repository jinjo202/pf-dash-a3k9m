...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-06-17T18:39:07Z",
  "regime": {
    "score": 15,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "peg": {
      ...
      "signal": "호재",
      "signal_cls": "pos",
      "desc": "Fwd PER 20.97 / EPS성장 16%. 1 미만 저평가, 2+ 부담",
      "as_of": "2026-06-17",
      "history": null,
      "source": {
  ...
  "commentary": {
    "macro": "[혼조/중립] ISM 제조업 PMI 52.7(강한 호재)·미국 CPI (YoY) 4.2%(강한 악재)·미국 근원 CPI (YoY) 2.8%(악재)·미국 실업률 4.3%(호재)·비농업 고용 (전월비) 172.0천명(호재)·장단기 금리차(10Y-2Y) 0.47%p(호재)·WTI 유가 (YoY) 17.1%(악재)",
    "valuation": "[부담 우위] S&P500 12M Fwd PER 21.0배(강한 악재)·KOSPI 12M Fwd PER 6.9배(강한 호재)·주식위험프리미엄(ERP) 0.35%p(악재)·미국 10Y 금리 4.43%(중립)",
    "flows": "[완만한 호재 우위] M2 통화량 (YoY) 4.7%(강한 호재)·신용 스프레드(Baa-10Y) 1.57%p(호재)·USD/KRW 1519.8원(강한 악재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 120.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -21.2조원(악재)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 16.6(중립)·S&P500 12M 모멘텀 21.1%(강한 호재)·CNN 공포·탐욕 지수 60(호재)·AAII 불-베어 스프레드 -6.3%p(호재)·CBOE 풋/콜 비율(총) 0.74(강한 악재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.495(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.289(상향 우위)·한국 Fwd EPS 수정(1개월) 0.0%(유지)",
    "overall": "종합 레짐 점수 +15. 매크로 -1, 밸류 -12, 수급 +17, 센티 +20, 기업이익 +45."
  },
  "outlook": {
    "short": {
      "bias": "상승",
