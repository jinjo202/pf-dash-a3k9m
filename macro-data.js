...
window.MACRO = {
  ...
  "update_log": [
    ...
    },
    {
      ...
      "detail": "40.9배 → 40.4배 (2026-07-23 발표)",
      "as_of": "2026-07-23"
    },
    {
      "date": "2026-07-23",
  ...
  "generated": "2026-07-31T01:18:56Z",
  "regime": {
    "score": 29,
    "label": "비중확대 우위",
    "cls": "pos",
  ...
  "indicators": {
    ...
    "kr_flows": {
      ...
      "signal": "중립",
      "signal_cls": "neu",
      "desc": "2026.07 KOSPI 누적(조원): 외국인 -11.2·기관 +2.7·개인 +8.0(22일). 최근 26.07.31: 외국인 +5.88·기관 -0.18·개인 -5.64. 외인 순매도를 개인·기관(연기금·ETF)이 흡수하는 구조. 자동수집(네이버 금융).",
      "as_of": "2026-07-31",
      "history": null,
      "manual": true,
      "kind": "release",
    ...
    "eps_rev_kr": {
      ...
      "signal": "유지",
      "signal_cls": "neu",
      "desc": "올해 컨센서스 EPS의 최근 30일 변화율(단기 모멘텀 유지). 7일 +0.0%·90일 +1.2%. 그래프=90일 경로.",
      "as_of": "2026-07-31",
      "history": {
        "dates": [
          "90일전",
          ...
          "holdings": [
            {
              ...
              "rev30": -0.16934982945709942,
              "note": "메모리·HBM·파운드리 턴"
            },
            {
              "ticker": "000660.KS",
              "name": "SK hynix",
              "mktcap": 1200364707643392,
              "fwdpe": 3.7,
              "pbr": null,
              "rets": {
                "w1": -3.9,
          ...
          "holdings": [
            {
              ...
              "rev30": 7.519974962676046,
              "note": "주주환원·밸류업"
            },
            {
              "ticker": "055550.KS",
              "name": "ShinhanGroup",
              "mktcap": 46709744861184,
              "fwdpe": 7.4,
              "pbr": null,
              "rets": {
                "w1": -4.3,
              ...
              "rev30": 5.616595347735309,
              "note": "배당·NIM"
            },
            {
              "ticker": "086790.KS",
              "name": "HANAFINANCIALGR",
              "mktcap": 33454173454336,
              "fwdpe": 6.9,
              "pbr": null,
              "rets": {
                "w1": -5.8,
  ...
  "commentary": {
    "macro": "[완만한 호재 우위] ISM 제조업 PMI 53.3(강한 호재)·미국 CPI (YoY) 3.5%(강한 악재)·미국 근원 CPI (YoY) 2.6%(중립)·미국 실업률 4.2%(중립)·비농업 고용 (전월비) 57.0천명(악재)·장단기 금리차(10Y-2Y) 0.45%p(호재)·WTI 유가 (YoY) 22.5%(강한 악재)",
    "valuation": "[혼조/중립] S&P500 12M Fwd PER 18.6배(중립)·KOSPI 12M Fwd PER 4.2배(강한 호재)·주식위험프리미엄(ERP) 0.7%p(중립)·미국 10Y 금리 4.66%(중립)",
    "flows": "[전반적으로 우호적] M2 통화량 (YoY) 5.5%(강한 호재)·신용 스프레드(Baa-10Y) 1.6%p(호재)·USD/KRW 1434.3원(강한 호재)·미국 CTA 주식 노출(백분위) 43%ile(중립)·미국 리테일 주식비중 70%(악재)·한국 투자자예탁금 109.6조원(강한 호재)·한국 투자자별 수급(외국인, 월) -11.2조원(중립)",
    "sentiment": "[완만한 호재 우위] VIX 변동성 17.1(중립)·S&P500 12M 모멘텀 17.3%(강한 호재)·CNN 공포·탐욕 지수 39(악재)·AAII 불-베어 스프레드 -11.1%p(호재)·CBOE 풋/콜 비율(총) 1.05(호재)",
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 0.3%(유지)",
    "overall": "종합 레짐 점수 +29. 매크로 +14, 밸류 +5, 수급 +54, 센티 +21, 기업이익 +47."
  },
  "outlook": {
    "short": {
      "bias": "상승",
