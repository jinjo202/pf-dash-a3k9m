...
window.MACRO = {
  ...
  "updates_today": [],
  "generated": "2026-08-01T22:23:17Z",
  "regime": {
    "score": 28,
    "label": "비중확대 우위",
    "cls": "pos",
    ...
    "countries": {
      "US": {
        ...
        "annual": {
          ...
          "source": "FactSet Earnings Insight · EPS 기준 07/31 (1일 경과)",
          "actual_through": 2025,
      ...
      "KR": {
        ...
        "annual": {
          ...
          "source": "⚠️ 갱신 필요 · Goldman Sachs/MSCI · EPS 기준 05/31 (62일 경과)",
          "actual_through": 2025,
      ...
      "EU": {
        ...
        "annual": {
          "unit": "지수(2020=100, 근사)",
          "source": "⚠️ 갱신 필요 · 추정·편집 가능 · EPS 기준 05/31 (62일 경과)",
          "actual_through": 2025,
          "eps_as_of": "2026-05-31",
          "days_old": 62,
          "stale": true,
  ...
  "commentary": {
    ...
    "earnings": "[전반적으로 우호적] 미국 ERR(이익수정비율) 0.53(강한 상향)·미국 Fwd EPS 수정(1개월) 0.2%(유지)·한국 ERR(이익수정비율) 0.238(상향 우위)·한국 Fwd EPS 수정(1개월) 1.0%(유지)",
    "overall": "종합 레짐 점수 +28. 매크로 +14, 밸류 +4, 수급 +54, 센티 +15, 기업이익 +49."
  },
  "outlook": {
    "short": {
      "bias": "상승",
